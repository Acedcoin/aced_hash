...
# AceD block #1
# moo@b1:~/.AceD$ AceDd getblockhash 1
# 00000c8a1ff01bae3f3875c81cb14115429af5744643b34b4ad1cbb7d2d59ca2
# moo@b1:~/.AceD$ AceDd getblock 00000c8a1ff01bae3f3875c81cb14115429af5744643b34b4ad1cbb7d2d59ca2
#{
...
class TestSequenceFunctions(unittest.TestCase):
    ...
    def test_AceD_hash(self):
        self.pow_hash = hexlify(AceD_hash.getPoWHash(self.block_header))
